...
if "__main__" == __name__:
    ...
    parser.add_argument("--stage", type=str, default=None, help="Stage to load params from. If None, loads the last stage in dvc.yaml")
    parser.add_argument("--layer", type=str, default="runner", help="Layer to run. Choose from " + str(LAYERS))
    ...
    parser.add_argument("params", type=list, default=None, help="Params to merge with params from dvc.yaml. Params can be a json dict or a path to a yaml file.", nargs="*")
    ...
    logger.info(f"Running params {args.params}.")
