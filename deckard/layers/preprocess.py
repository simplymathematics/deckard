if __name__ == '__main__':
    ...
    from deckard.base.parse import parse_list_from_yml, generate_object_list, transform_params_for_pipeline, insert_layer_into_pipeline, generate_experiment_list
    import argparse
    from os import path
    import logging
