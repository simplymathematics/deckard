...
#                 f"Suffix {self.suffix} not implemented. Try adding it to the LoaderConfig._load method in this file: {__file__}",
#             )
...
#             output_suffix: Union[str, Path] = ".npz",
#         ) -> Any:
#             df = pd.DataFrame()
#             for data in self:
...
#             new_list = list(
#                 Path(kwargs.pop("directory")).glob(
#                     kwargs.pop("regex") + kwargs.pop("suffix"),
#                 ),
#             )
...
#             else:
#                 raise NotImplementedError(
#                     f"Suffix {self.suffix} not implemented. Try adding it to the LoaderConfig._save method in this file: {__file__}",
#                 )
...
#                 assert (
#                     "regex" in kwargs
#                 ), "Must specify regex if directory is specified."
#                 self.regex = kwargs.pop("regex")
#                 assert (
#                     "suffix" in kwargs
#                 ), "Must specify suffix if directory is specified."
...
#                 self.generator = field(
#                     default_factory=Union[
#                         ClassificationGeneratorConfig, RegressionGeneratorConfig,
#                     ],
#                 )
#             if "loader" in kwargs:
...
#                 assert not (
#                     "name" in kwargs and "__target__" in kwargs
#                 ), "Cannot specify both name and __target__."
...
#                         self,
#                         k,
#                         [instantiate(i) if isinstance(i, dict) else i for i in v],
#                     )
#                     kwargs.pop(k)
...
#                 else:
#                     raise NotImplementedError(
#                         f"Cannot parse {v} of type {type(v)}. Please specify a dict, list, int, float, str, or bool. You could also modify the FactoryConfig class in this file: {__file__}",
#                     )
