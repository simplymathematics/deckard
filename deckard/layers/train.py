...
from deckard.base.hashable import (generate_queue, my_hash,
                                   sort_queue)

layers = {
    "fit": {"fit": True},
    "data": {"fit": False, "predict": False, "score": False, "visualise":False, "art": False, "attack" : False},
    "predict": {"predict": True},
    "evaluate": {"score": True},
    "visualise": {"visualise": True},
    "attack": {"attack": True},
    "art" : {"art": True},
    "all" : {"fit": True, "predict": True, "score": True, "visualise": True, "art": True, "attack": True},
}
...
if __name__ == "__main__":
    ...
    if "data" in params:
        params['data']['files']['data_path'] = str(Path(args.stage, params['data']['files']['data_path']))
    if "model" in params:
        params['model']['files']['model_path'] = str(Path(args.stage, params['model']['files']['model_path']))
    if "attack" in params:
        params["files"]["attack_path"] = str(Path(args.stage, params["files"]["attack_path"]))
    tag = "!Experiment:"
