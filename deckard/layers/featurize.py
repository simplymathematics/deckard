from deckard.base import Data, Model, Experiment, return_result, load_checkpoint, checkpoint
...
if __name__ == '__main__':
    ...
    if os.path.isfile(os.path.join(args.folder, 'best_features', 'results.json')):
    ...
    for data in pres:
        ...
        if score > best_score:
            ...
            cmd = "cp -r {} {}".format(os.path.join(args.folder, 'best_preprocess'), os.path.join(args.folder, 'best_features'))
