...
the plot layer (``deckard.plugins.yellowbrick.plot``) so they are available to
...
try:
    ...
    # Keep scoring utilities importable when torch is unavailable or fails to initialize.
    torch = None
    TorchSubset = None
    HAS_TORCH = False
