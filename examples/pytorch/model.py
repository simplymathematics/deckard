...
class SampleNet(nn.Module):
    def __init__(self):
        ...
        print("conv[0] = ", conv[0])
        self.conv_1 = nn.Conv2d(in_channels=input_channels, out_channels=conv[0], kernel_size=kernel_size, stride=stride, padding = padding)
        print("conv[1] = ", conv[1])
        self.conv_2 = nn.Conv2d(in_channels=conv[0], out_channels=conv[1], kernel_size=kernel_size, stride=stride, padding = padding)
        print("conv[0]*conv[0]*conv[1] *input_channels = ", conv[0]*conv[0]*conv[1] *input_channels)
        print("lin[0] = ", lin[0])
        self.fc_1 = nn.Linear(in_features=conv[0]*conv[0]*conv[1]*input_channels, out_features=lin[0])
