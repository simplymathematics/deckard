...
def objective(trial: optuna.Trial):
    ...
    if model_type == "knn":
        ...
        params = {"C": C, "solver": solver, "penalty": penalty, "fit_intercept": fit_intercept, "class_weight": class_weight}  
    elif model_type == "svc":
        C = trial.suggest_loguniform("C", 1e-10, 1e10)
        ...
        if kernel == "poly":
            ...
            params = {"C": C, "kernel": kernel, "degree": degree, "class_weight": class_weight}
        elif kernel == "rbf":
            gamma = trial.suggest_categorical("gamma", ["auto", "scale"])
            params = {"C": C, "kernel": kernel, "gamma": gamma, "class_weight": class_weight}
        else:
