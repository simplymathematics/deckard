...
if __name__ == "__main__":
    ...
    val_cols = ['accuracy', 'predict_time', 'train_time', "train_time_per_sample", "predict_time_per_sample"]
    do_not_group = ['model.init.distance_matrix_train', 'model.init.distance_matrix_test']
    ...
    sns.set_theme(context='paper', style='whitegrid', font='Times New Roman', font_scale=1)
    ...
    distance_matrix_time_graph.set_axis_labels("Metric", "Distance Matrix Calculation \n Time per Sample (seconds)")
    ...
    distance_matrix_time_graph.savefig("output/combined/plots/distance_matrix_time_vs_algorithm.pdf")
    sns.set_theme(context='paper', style='whitegrid', font='Times New Roman', font_scale=2)
    ...
    sns.set_theme(context='paper', style='whitegrid', font='Times New Roman', font_scale=1.5)
