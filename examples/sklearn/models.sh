...
python -m deckard.layers.optimise +model.art.preprocessor.name=art.defences.preprocessor.FeatureSqueezing +model.art.preprocessor.params.bit_depth=4,8,16,32,64 +stage=train +optimizers=accuracy --multirun
