...
def merge_run(big_dir, little_dir,  output_file="merged", data_file = "raw.csv", little_dir_data_file = None, fillna={"model.art.preprocessor.name" : "art.defences.preprocessor.FeatureSqueezing", "model.art.preprocessor.params" : "bit_depth"}):
    """
    ...
    saved_path = save_results(merged, results_file=results_file, results_folder=results_folder)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--big_dir", type=str, help="Directory of the big run", required=True)
    parser.add_argument("--little_dir", type=str, help="Directory of the small run", required=False)
    parser.add_argument("--data_file", type=str, help="Name of the data file", required=True)
    parser.add_argument("--output_file", type=str, help="Name of the output file", default="merged.csv")
    parser.add_argument("--output_folder", type=str, help="Name of the output folder", required=False)
    parser.add_argument("--little_dir_data_file", type=str, help="Name of the output folder", required=False)
    parser.add_argument("--config", type=str, help="Name of the output folder", required=False)
