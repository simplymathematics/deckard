...
- [ ] Integrate experiment/power.py
- [x] Update developers/dvc.md to reflect canon and change the narrative from a plan to a finalized design spec.
- [ ] Update dvc.ipynb to reflect the new canon
- [ ] Generate dvc.yaml and params.yaml for several experiments (run AND multirun) that demonstrate several Vega-Lite graphs.
...
- [ ] Add one notebook per core module to demonstrate canon runtime behavior end-to-end:
  - [ ] data (including pipelines and sampling)
  - [ ] model (including trainers and defense subtypes)
  - [ ] attack (including attack subtypes)
  - [ ] detector (evasion/poisoning paths for both train/filter)
  - [ ] scoring (data, model, attacks, fairness scores)
  - [ ] files/artifacts (explaining hooks, stages, persistence, and path templating)
  - [ ] plugins
...
- [ ] Run coverage + focused refactor test suites and update
  `docs/developers/plan` progress.

______________________________________________________________________

**Design Specs:** [Config Declaration
Architecture](declarations) | [Naming
