...
Deckard keeps plotting defaults in [deckard/plot/.matplotlibrc](../../deckard/plot/.matplotlibrc).
...
- Generator script: [scripts/generate_matplotlibrc.py](../../scripts/generate_matplotlibrc.py)
- Generated config: [deckard/plot/.matplotlibrc](../../deckard/plot/.matplotlibrc)
